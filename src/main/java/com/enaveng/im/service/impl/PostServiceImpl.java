package com.enaveng.im.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.enaveng.im.common.ErrorCode;
import com.enaveng.im.constant.CommonConstant;
import com.enaveng.im.exception.BusinessException;
import com.enaveng.im.exception.ThrowUtils;
import com.enaveng.im.mapper.PostFavourMapper;
import com.enaveng.im.mapper.PostMapper;
import com.enaveng.im.mapper.PostThumbMapper;
import com.enaveng.im.model.dto.post.PostEsDTO;
...
import com.enaveng.im.utils.SqlUtils;
...
import static com.enaveng.im.constant.PostConstant.POST_ID;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public Page<Post> searchFromEs(PostQueryRequest postQueryRequest) {
        ...
        // 过滤
        filterPost(id, notId, userId, boolQueryBuilder);
        // 必须包含所有标签
        if (CollUtil.isNotEmpty(tagList)) {
            for (String tag : tagList) {
        ...
        keySearch(searchText, title, content, boolQueryBuilder);
        // 排序
        ...
        getNewData(searchHits, resourceList);
        page.setRecords(resourceList);
        return page;
    }

    private void getNewData(SearchHits<PostEsDTO> searchHits, List<Post> resourceList) {
